...
export default function HomePage() {
  ...
  const [selectdata, setSelectData] = useState<ReportInsert>();
                  ...
                  <div className="card scroll">
                    ...
                    <div className="card-body ">
                      ...
                      <div className="row">
                        <div className="col-sm-12 grid-margin">
                          <h2 className="mb-2 font-weight-600">
                            โครงการ ลุ้นโชค " ช่วยผู้ปกครอง รับค่าเทอมนักศึกษา
                            สูงสุด 5,000 บาท (ห้าพันบาทถ้วน) "
                      ...
                      <div className="row">
                        <div className="col-sm-12 grid-margin">
                          <h2 className="mb-2 font-weight-600">
                            ...
                            สำหรับผู้สำเร็จการศึกษาประจำภาคเรียนที่ 2 ปีการศึกษา
                            2562
                          </h2>
                          <div className="fs-13 mb-2 text-right">
                            <a
